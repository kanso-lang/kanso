...
> Entries before 2026-08-01. Split out when the live log passed seventeen
> thousand lines and had become write-mostly: appended on every change, read
> only at the tail. Nothing here is edited either — this is the same file,
> older end.
