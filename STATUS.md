...
below. The **twenty-one** that remain are all September; three of them were
...
**eighteen** are unread. Two in thirty-five is not zero, so what September holds is a guess until
