...
# grows. The literal is built by k_list_empty since 2026-09-25, and this
# gives the buffer it carves a capacity of one again. Every list holds the
...
sed -i 's/^        b->cap = 4;$/        b->cap = 1;/' src/runtime.c
