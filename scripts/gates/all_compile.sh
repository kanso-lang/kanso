...
gates="machine_code emitted_code compile_memory compile_allocs compile_instructions entry_instructions library_instructions compile_libraries codegen_instructions"
moved=""
refused=""
regen=""
for g in $gates; do
